            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                ...
                <input
                  ...
                  className="uppercase text-sm font-bold cursor-pointer tracking-wide bg-gray-500 hover:bg-blue-900 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
                />
              </div>
            </div>
          </form>
